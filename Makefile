...
SRC := agent.el agent-account.el agent-claude.el agent-codex.el agent-chief.el
TEST_FILES := test/agent-test.el test/agent-account-test.el test/agent-claude-test.el test/agent-codex-test.el test/agent-chief-test.el
